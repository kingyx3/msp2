...
describe('Make a booking via picking datetime & ListMap', () => {
  ...
  it('Navigate to ListMap screen', async () => {
    ...
    // Wait for navigation to complete & perform the visibility checks
    await waitFor(element(by.id('listing-card-flatlist'))).toBeVisible().withTimeout(30000);
  });
...
describe('Make a booking via quick search & Listings', () => {
  ...
  it('Navigate to ListMap screen', async () => {
    ...
    // Wait for navigation to complete & perform the visibility checks
    await waitFor(element(by.id('listing-card-flatlist'))).toBeVisible().withTimeout(20000);
  });
